...
module.exports = function (webpackEnv) {
    ...
    return {
        ...
        output: {
            path: isEnvProduction ? process.env.APP_BUILD : undefined,
                    ...
                    oneOf: [
                        ...
                        },
                        {
                            ...
                            use: getStyleLoaders({
                                ...
                                sourceMap: isEnvProduction && shouldUseSourceMap,
                                modules: {
                                    getLocalIdent: (...params) => getCSSModuleLocalIdent(...params).replace(/\./g, '_'),
                                },
                            }),
                        },
                        {
        ...
        plugins: [
            process.env.APP_HTML && new HtmlWebpackPlugin(
                Object.assign(
                    {},
                    {
                        inject: true,
                        template: process.env.APP_HTML,
                    },
                    isEnvProduction
                        ? {
                            minify: {
                        ...
                        : undefined,
                    process.env.APP_HTML_NAME ? {
                            filename: process.env.APP_HTML_NAME,
                        }
                        : undefined,
                )
            ),
